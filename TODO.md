...
- [ ] Phase-5 Folge: Effekt-Widgets schrittweise aufs Gate umziehen (cinema_overlay, tilt_card, film_grain, glass_card-Blur), Pressable-Spring-Release via AppMotion, AnimatedEntrance-Spring-Option, danach Phase-5b-Transitions.
