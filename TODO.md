...
- [ ] Marketing Phase 3 OFFEN: C16 Win-Back-ueber-anderen-Kanal (Backend), C19 Feedback-nach-Hilfe (Trigger auf interactions completed -> testimonials-Bitte).
- [ ] Marketing Phase 4 offen: Content-Planer, Geburtstags-/Eskalations-Reaktivierung, Smart-Timing, Win-Back, Region-Zuend-Warnung, Social-Content-Generator, Feedback-nach-Hilfe, Wochen-Health-Report.
