...
class DashboardWidgetConfig {
  ...
  static const List<DashboardWidgetMeta> all = [
    DashboardWidgetMeta(
      id: 'hero',
      title: 'Begrüßung',
      description: 'Personalisierter Hero mit Tageszeit-Stimmung',
    ...
    DashboardWidgetMeta(
      ...
      description: 'NINA + Lebensmittel-Rückrufe',
    ...
    DashboardWidgetMeta(
      id: 'onboarding',
      title: 'Einstieg',
      description: 'Onboarding-Checkliste für neue Nachbarn',
      icon: LucideIcons.checkCircle,
    ),
    DashboardWidgetMeta(
      id: 'quick_actions',
      title: 'Schnell-Aktionen',
      description: '3 wichtigste Modul-Shortcuts',
      icon: LucideIcons.zap,
    ),
    DashboardWidgetMeta(
      id: 'stats',
      title: 'Statistik',
      description: 'In-der-Nähe, Ungelesen, Aktiv',
      icon: LucideIcons.barChart3,
    ),
    DashboardWidgetMeta(
      id: 'smart_match',
      title: 'Smart-Match',
      description: 'Top 3 KI-Vorschläge',
      icon: LucideIcons.sparkles,
    ),
    DashboardWidgetMeta(
      id: 'trust_score',
      title: 'Vertrauen',
      description: 'Trust-Score mit Level-Anzeige',
      icon: LucideIcons.shieldCheck,
    ),
    DashboardWidgetMeta(
      id: 'thanks',
      title: 'Dank erhalten',
      description: 'Letzte Trust-Ratings mit Sternen',
      icon: LucideIcons.heart,
    ),
    DashboardWidgetMeta(
      id: 'community_pulse',
      title: 'Community-Puls',
      description: '24h-Aktivität in der Nachbarschaft',
      icon: LucideIcons.activity,
    ),
    DashboardWidgetMeta(
      id: 'activity_feed',
      title: 'Aktivität',
      description: 'Live-Updates der eigenen Interaktionen',
      icon: LucideIcons.zap,
    ),
    DashboardWidgetMeta(
      id: 'mini_map',
      title: 'Karte',
      description: 'Mini-Karte mit Posts in der Nähe',
      icon: LucideIcons.mapPin,
    ),
    DashboardWidgetMeta(
      id: 'weekly_digest',
      title: 'Wochen-Übersicht',
      description: 'Beiträge, Hilfen, Nachrichten letzte 7 Tage',
