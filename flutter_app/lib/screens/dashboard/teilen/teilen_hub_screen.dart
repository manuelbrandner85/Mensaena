...
/// Teilen-Hub — Launcher für die 3 Teilen-Module
/// (Verschenken/Verleihen · Verkaufen/Tauschen · Zeit-gegen-Zeit).
library;
...
class TeilenHubScreen extends ConsumerWidget {
  const TeilenHubScreen({super.key});
