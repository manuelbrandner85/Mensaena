...
class CommunityScreen extends ConsumerStatefulWidget {
  ...
  @override ConsumerState<CommunityScreen> createState() => _CommunityScreenState();
}
...
class _CommunityScreenState extends ConsumerState<CommunityScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final posts = await ref.read(postServiceProvider).getPosts(type: 'community', search: _search.isNotEmpty ? _search : null);
