...
class HarvestScreen extends ConsumerStatefulWidget {
  ...
  @override ConsumerState<HarvestScreen> createState() => _HarvestScreenState();
}
...
class _HarvestScreenState extends ConsumerState<HarvestScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final posts = await ref.read(postServiceProvider).getPosts(type: 'rescue', search: _search.isNotEmpty ? _search : null);
  ...
  @override Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('🌾 Ernte & Hofladen')),
