...
class MobilityScreen extends ConsumerStatefulWidget {
  ...
  @override ConsumerState<MobilityScreen> createState() => _MobilityScreenState();
}
...
class _MobilityScreenState extends ConsumerState<MobilityScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final posts = await ref.read(postServiceProvider).getPosts(type: 'mobility', search: _search.isNotEmpty ? _search : null);
