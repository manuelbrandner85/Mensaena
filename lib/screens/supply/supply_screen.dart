...
class _SupplyScreenState extends ConsumerState<SupplyScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('\u{1F4E6} Regionale Versorgung'),
      ),
      body: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: const Text(
              'Finde und biete regionale Versorgungsangebote in deiner Nachbarschaft.',
              style: TextStyle(
                fontSize: 14,
              ...
              child: _loading
                  ...
                  : _posts.isEmpty
                      ? const EmptyState(
                          ...
                          message:
                              'Hier gibt es noch keine Versorgungsangebote. Erstelle den ersten Beitrag und hilf deiner Region!',
                        )
                      : ListView.builder(
                          padding: const EdgeInsets.symmetric(horizontal: 16),
