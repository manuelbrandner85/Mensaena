          ...
          data: (conversations) {
            if (conversations.isEmpty) {
              return const EmptyState(
                ...
                message: 'Du hast noch keine Unterhaltungen. Kontaktiere jemanden zu einem Beitrag!',
              );
            }
                ...
                return _ConversationTile(
                  ...
                  onTap: () {
                    final convId = conv['conversation_id'] as String? ??
                        (conv['conversations'] as Map<String, dynamic>?)?['id'] as String?;
                    if (convId != null) {
    ...
    return ListTile(
      ...
      leading: Container(
        ...
        decoration: BoxDecoration(
          color: type == 'direct' ? AppColors.primary50 : AppColors.trustLight,
          shape: BoxShape.circle,
        ),
        child: Icon(
          type == 'direct' ? Icons.person_outline : Icons.group_outlined,
          color: type == 'direct' ? AppColors.primary500 : AppColors.trust,
        ),
      ),
      title: Text(
        title,
