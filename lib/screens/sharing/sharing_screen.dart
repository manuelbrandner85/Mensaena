...
class SharingScreen extends ConsumerStatefulWidget {
  ...
  @override ConsumerState<SharingScreen> createState() => _SharingScreenState();
}
...
class _SharingScreenState extends ConsumerState<SharingScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final posts = await ref.read(postServiceProvider).getPosts(type: 'sharing', search: _search.isNotEmpty ? _search : null);
  ...
  @override Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('🔄 Teilen & Tauschen')),
