...
export default function NotificationBell({ userId }: { userId?: string }) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-80 bg-white rounded-2xl shadow-2xl border border-warm-200 z-50 overflow-hidden animate-scale-in">
          {/* Header */}
          ...
          {permission === 'default' && (
            <div className="mx-3 mt-3 p-3 bg-primary-50 rounded-xl border border-primary-200">
              ...
              <p className="text-xs text-gray-500 mb-2">Erhalte sofortige Benachrichtigungen bei neuen Nachrichten.</p>
