...
export default function ModulePageLayout({
  ...
  accentColor = 'bg-mn-bronze/5 text-mn-bronze border border-white/8',
  index = '§',
}: ModulePageProps) {
  return (
          ...
          {features.map((feature, i) => {
            const body = (
              <>
                ...
                {feature.href && (
                  <div className="inline-flex items-center gap-1 text-xs tracking-[0.14em] uppercase text-mn-bronze font-semibold mt-4 opacity-0 -translate-x-1 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300">
