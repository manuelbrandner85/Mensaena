...
import TrustScoreDetail from '@/app/ratings/components/TrustScoreDetail'
import RatingsList from '@/app/ratings/components/RatingsList'
import TrustScoreBadge from '@/app/ratings/components/TrustScoreBadge'
import { useRatings } from '@/app/ratings/hooks/useRatings'
...
export default function ProfileView({
  ...
  const ratingsHook = useRatings(profile.id)
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-5 pb-12">
      ...
      {/* ── Trust Score Detail ────────────────────────────────────────── */}
      {ratingsHook.trustScore && ratingsHook.trustScore.count > 0 && (
        <TrustScoreDetail data={ratingsHook.trustScore} />
      )}
      ...
      <div className="bg-white rounded-2xl shadow-sm p-6">
        <RatingsList
          ...
          hasMore={ratingsHook.hasMore}
          filter={ratingsHook.filter}
          onFilterChange={ratingsHook.setFilter}
          onLoadMore={ratingsHook.loadMore}
          currentUserId={store.userId ?? undefined}
