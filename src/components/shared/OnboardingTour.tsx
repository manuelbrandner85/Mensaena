    ...
    >
      ...
      >
        ...
        <button
          type="button"
          onClick={complete}
          className="absolute top-4 right-4 z-10 p-2 rounded-full text-mn-mute hover:text-mn-ink hover:bg-mn-elevated/5 transition-colors"
        ...
        <div className="relative p-7 sm:p-10">
          ...
          <h2
            id="onboarding-title"
            className="font-display text-2xl sm:text-3xl font-medium text-mn-ink tracking-tight mb-3 leading-tight"
          >
            {step.title}
          </h2>

          {/* Body */}
          <p className="text-sm sm:text-base text-mn-ink-soft leading-relaxed mb-8">
            {step.body}
          </p>
          ...
          <div className="flex items-center justify-between gap-3">
            <button
              type="button"
              onClick={complete}
              className="text-xs font-medium text-mn-mute hover:text-mn-ink transition-colors px-2 py-2"
            >
              Überspringen
            </button>
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                onClick={prev}
                disabled={isFirst}
                className="flex items-center gap-1.5 px-4 py-2.5 rounded-xl text-sm font-medium border border-white/5 text-mn-ink-soft hover:bg-mn-elevated/5 transition-all disabled:opacity-40 disabled:cursor-not-allowed min-h-[44px]"
              >
