  ...
  if (variant === 'icon') {
    return (
      <button
        ...
        aria-label="Drucken"
        className={cn(
          'p-2 rounded-lg text-mn-mute hover:bg-mn-elevated/5 hover:text-mn-ink-soft transition-colors',
          className
        )}
      >
  ...
  return (
    <button
      ...
      className={cn(
        ...
        'text-mn-ink-soft bg-mn-elevated hover:bg-mn-raised transition-colors',
        className
      )}
    >
      <Printer className="w-4 h-4" />
