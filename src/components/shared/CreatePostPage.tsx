                ...
                {createTypes.map(t => (
                  <button
                    ...
                    className={cn(
                      ...
                      form.type === t.value
                        ? cn('bg-mn-amber/5 border-primary-400 ring-2 text-primary-800', ringColor)
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-2">
                <button
                  ...
                  className="min-h-[44px] flex items-center gap-1.5 px-3 py-2 text-xs font-medium border border-primary-300 bg-mn-amber/5 text-mn-amber rounded-xl hover:bg-mn-amber/10 transition-all disabled:opacity-60"
                >
                  {gettingLocation
