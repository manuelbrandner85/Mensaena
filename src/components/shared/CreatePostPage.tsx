      ...
      <div className="min-h-dvh flex items-center justify-center bg-mn-bronze/5">
        <div className="text-center p-8">
          <div className="w-16 h-16 bg-mn-bronze/10 border border-mn-bronze/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
            <CheckCircle2 className="w-8 h-8 text-mn-bronze" aria-hidden="true" />
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {createTypes.map(t => (
                  <button
                    ...
                    className={cn(
                      ...
                      form.type === t.value
                        ? cn('bg-mn-bronze/5 border-mn-bronze/30 ring-2 text-primary-800', ringColor)
          ...
          <div className="bg-mn-elevated rounded-2xl border border-white/5 shadow-md p-6">
            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                { v: 'low',    l: '🟦 Normal',   a: 'bg-mn-bronze text-white border-primary-600' },
                ...
                <button
                  ...
                  className={cn(
                    ...
                    form.urgency === v ? a : 'bg-mn-elevated text-mn-ink-soft border-white/5 hover:border-mn-bronze/20',
                  )}
                >
                  {l}
                </button>
                ...
                <div className="mb-2 p-2 bg-mn-surface border border-white/5 rounded-xl space-y-1">
                  {suggestions.map(s => (
                    <button
                      ...
                      className="block w-full text-left text-xs text-mn-bronze hover:bg-mn-elevated px-2 py-1 rounded-lg transition-colors"
                    >
                      {s}
                    </button>
                  ))}
          ...
          <div className="bg-mn-elevated rounded-2xl border border-white/5 shadow-md p-6 space-y-3">
            <h2 className="font-bold text-mn-ink text-lg flex items-center gap-2">
              <MapPin className="w-5 h-5 text-mn-bronze" /> Standort
            </h2>
            <div>
              ...
              <div className="flex items-center gap-2 mt-2">
                <button
                  ...
                  className="min-h-[44px] flex items-center gap-1.5 px-3 py-2 text-xs font-medium border border-mn-bronze/20 bg-mn-bronze/5 text-mn-bronze rounded-xl hover:bg-mn-bronze/10 transition-all disabled:opacity-60"
                >
                  {gettingLocation
          ...
          <div className="bg-mn-elevated rounded-2xl border border-white/5 shadow-md p-6">
            <h2 className="font-bold text-mn-ink text-lg mb-3 flex items-center gap-2">
              <Tag className="w-4 h-4 text-mn-bronze" /> Tags
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-mn-mute mt-0.5">
                  ...
                  <Link href="/nutzungsbedingungen" target="_blank" rel="noopener noreferrer" className="text-mn-bronze hover:underline ml-1">Siehe AGB §4</Link>
                </p>
              </div>
            </button>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="flex-1 min-h-[44px] py-3 bg-mn-bronze text-white rounded-xl text-sm font-semibold hover:bg-primary-700 disabled:opacity-60 transition-colors flex items-center justify-center gap-2"
            >
              {submitting
