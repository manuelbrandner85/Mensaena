  ...
  return (
    <>
      <button
        ...
        className={cn(
          'flex items-center gap-1.5 text-mn-mute hover:text-red-500 transition-colors',
          ...
          <div className="bg-mn-elevated rounded-2xl shadow-cinema-card-2xl w-full max-w-sm p-6 space-y-4" onClick={e => e.stopPropagation()}>
            ...
            {reason === 'Sonstiges' && (
              <textarea
                ...
                className="w-full px-3 py-2 border border-white/5 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-red-300 resize-none h-20"
                maxLength={500}
              />
            )}
