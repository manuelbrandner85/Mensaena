          ...
          <button
            ...
            className={cn(
              ...
              activeChip === chip.label
                ? 'bg-mn-bronze/5 border-mn-bronze/20 text-mn-bronze font-medium'
                : 'bg-mn-elevated hover:bg-mn-bronze/5 border-white/5 hover:border-mn-bronze/20 text-stone-700 hover:text-mn-bronze',
            )}
          >
            {chip.label}
          </button>
