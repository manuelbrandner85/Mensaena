...
import { LAYER_META, OVERPASS_LAYERS, type OverpassLayer } from '@/lib/services/overpass'
...
export default function MapLayerControl({
  ...
  return (
    <div
      className="absolute top-3 right-3 z-[500] bg-white/95 backdrop-blur-md rounded-2xl shadow-lg border border-stone-200 overflow-hidden"
