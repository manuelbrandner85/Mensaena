...
export function WidgetWrapper({
  ...
  return (
    ...
    >
      <header className="flex items-center justify-between border-b border-gray-100 px-3 py-2 dark:border-gray-700">
        <div className="flex items-center gap-2">
          {draggable && (
            <button
              type="button"
              aria-label="Widget verschieben"
              className="cursor-grab rounded p-1 text-gray-400 hover:bg-gray-100 active:cursor-grabbing dark:hover:bg-gray-700"
            >
