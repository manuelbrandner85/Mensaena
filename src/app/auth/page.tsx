        ...
        <div className="card p-8 shadow-hover">
          ...
          <form onSubmit={mode === 'login' ? handleLogin : handleRegister} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="bg-emerald-600 hover:bg-emerald-700 text-white w-full flex items-center justify-center gap-2 py-3.5 text-base font-semibold rounded-xl transition-colors min-h-[44px] disabled:opacity-60"
            >
              {loading ? (
                <>
