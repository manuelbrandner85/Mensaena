...
function UnsubscribeContent() {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-soft border border-gray-100 overflow-hidden">
        {/* Header */}
        ...
        <div className="p-8 text-center">
          {state === 'loading' && (
            <>
              ...
              <p className="text-gray-600 text-sm">Wird verarbeitet…</p>
            </>
          )}
          ...
          {state === 'success' && (
            <>
              ...
              <h2 className="text-xl font-bold text-gray-900 mb-2">Erfolgreich abgemeldet</h2>
              <p className="text-sm text-gray-600 leading-relaxed">
                {email ? (
                  <>Die Adresse <strong className="text-gray-900">{email}</strong> erhält keine weiteren Marketing-E-Mails von Mensaena mehr.</>
                ) : (
          ...
          {state === 'error' && (
            <>
              ...
              <h2 className="text-xl font-bold text-gray-900 mb-2">Abmeldung fehlgeschlagen</h2>
