...
export default function LandingHero() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 pt-24 w-full">
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-3">
            ...
            {/* Headline – stagger each line */}
            <h1 id="hero-heading" className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
            ...
            {/* Subheadline */}
            <p className="text-lg md:text-xl text-gray-600 max-w-xl mt-6 leading-relaxed animate-fade-up" style={{ animationDelay: '300ms' }}>
              Hilfe anbieten. Hilfe finden. Nachbarn kennenlernen. Mensaena verbindet 
              Menschen in deiner Nähe – kostenlos, gemeinnützig und von der Gemeinschaft getragen.
            </p>

            {/* CTA Buttons */}
            <div className="mt-8 flex flex-col sm:flex-row gap-4 animate-fade-up" style={{ animationDelay: '400ms' }}>
              <Link
              ...
              <button
                ...
                className="btn-secondary px-8 py-4 text-lg min-h-[44px]"
              >
                Mehr erfahren ↓
              </button>
            </div>
            ...
            {/* Trust line */}
            <div className="mt-6 flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-gray-500 animate-fade-up" style={{ animationDelay: '500ms' }}>
              ...
              <span className="text-gray-300">·</span>
              <span><span className="text-primary-500">✓</span> Gemeinnützig</span>
            </div>
          </div>

          {/* Visual – 40% (Desktop only) */}
            ...
            <div className="relative w-full max-w-sm">
              ...
              <div className="absolute -top-2 -left-4 w-64 bg-white rounded-2xl shadow-lg border border-warm-200 p-5 transform -rotate-3 animate-landing-float z-10">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">Einkaufshilfe für Nachbarn</p>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute top-52 left-2 w-56 bg-white rounded-2xl shadow-lg border border-warm-200 p-5 transform -rotate-1 animate-landing-float z-10" style={{ animationDelay: '2s' }}>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-gray-900">Straßenfest</p>
