  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: 'radial-gradient(ellipse 60% 50% at 50% 50%, rgba(30,170,166,0.18), transparent 65%)' }}
        aria-hidden="true"
      />
      <div className="relative max-w-5xl mx-auto">
        <div className="reveal meta-label mb-10">{t('ctaMeta')}</div>
        <h2 id="cta-heading" className="reveal reveal-delay-1 display-xl !text-stone-100 max-w-4xl">
          {t('ctaTitle')}
        </h2>
