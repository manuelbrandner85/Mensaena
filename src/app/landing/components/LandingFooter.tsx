  ...
  return (
    <footer className="relative overflow-hidden safe-area-bottom" style={{ background: '#060A14' }} role="contentinfo">
      ...
      <div className="absolute inset-x-0 top-0 pointer-events-none" aria-hidden="true">
        <div className="h-px" style={{ background: 'linear-gradient(to right, transparent, rgba(245,158,11,0.35), transparent)' }} />
        <div className="h-40" style={{ background: 'linear-gradient(to bottom, rgba(245,158,11,0.04) 0%, transparent 100%)' }} />
      </div>
      {/* Ambient orbs */}
      <div className="absolute rounded-full pointer-events-none" style={{ top: '-5%', right: '-10%', width: '45vw', height: '45vw', background: 'radial-gradient(circle, rgba(245,158,11,0.08) 0%, transparent 70%)', filter: 'blur(90px)' }} aria-hidden="true" />
      <div className="absolute rounded-full pointer-events-none" style={{ bottom: '15%', left: '-8%', width: '35vw', height: '35vw', background: 'radial-gradient(circle, rgba(14,165,233,0.05) 0%, transparent 70%)', filter: 'blur(80px)' }} aria-hidden="true" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 pt-24 md:pt-32">
        ...
        >
          Mensaena<span style={{ color: 'rgba(245,158,11,0.70)' }}>.</span>
        </div>
        <p
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 mt-24 pt-8" style={{ borderTop: '1px solid rgba(245,240,232,0.08)' }}>
        <Link
          href="/spenden"
