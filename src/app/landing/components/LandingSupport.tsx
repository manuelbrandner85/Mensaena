      ...
      <div className="relative max-w-6xl mx-auto">
        <header className="reveal max-w-3xl mb-16 md:mb-20">
          ...
          >
            ...
            <span style={{ color: 'rgba(199,147,99,0.85)' }}>Für immer.</span>
          </h2>
          <p className="reveal reveal-delay-2 mt-6 text-lg leading-relaxed" style={{ color: 'rgba(236,229,214,0.50)' }}>
        ...
        >
          ...
          <div
            ...
            style={{ borderRight: '1px solid rgba(199,147,99,0.10)' }}
          >
            <div className="flex items-center gap-3 mb-8">
              <div className="cinema-icon-surface w-11 h-11 rounded-2xl flex items-center justify-center">
                <Heart className="w-5 h-5 text-mn-bronze" style={{ fill: 'rgba(199,147,99,0.25)' }} />
              </div>
            ...
            <p className="leading-relaxed mb-10 max-w-xl" style={{ color: 'rgba(236,229,214,0.50)' }}>
          ...
          {/* Right: Quick facts */}
          <div className="md:col-span-2 p-10 md:p-14" style={{ background: 'rgba(199,147,99,0.03)' }}>
  ...
  return (
    <li className="flex gap-4">
      ...
      <div className="min-w-0">
        <div className="text-sm font-semibold mb-1" style={{ color: '#ece5d6' }}>{title}</div>
        <p className="text-[13px] leading-relaxed" style={{ color: 'rgba(236,229,214,0.75)' }}>{text}</p>
      </div>
    </li>
  )
}
