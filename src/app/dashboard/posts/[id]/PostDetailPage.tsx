    ...
    <div className="max-w-3xl mx-auto space-y-5 animate-fade-in pb-12">
      ...
      <div className="bg-white rounded-2xl shadow-sm p-6">
        <div className="flex items-center gap-4">
          ...
          {/* Trust score SVG */}
          {!isAnonymous && post.profiles?.trust_score != null && (
            <TrustCircle score={post.profiles.trust_score} />
          )}
          {/* Owner badge */}
          {isOwner && (
      ...
      <div className="flex-shrink-0">
        ...
        {interaction.status === 'accepted' && (
          <div className="text-center">
            <span className="inline-block text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full font-medium mb-1">
              &#x2705; Akzeptiert
            </span>
            <button
