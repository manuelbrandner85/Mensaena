        ...
        <div key={i} className="bg-white rounded-2xl border border-stone-100 p-4 animate-pulse">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="h-3 bg-stone-50 rounded w-full mt-3" />
              <div className="h-3 bg-stone-50 rounded w-2/3 mt-1" />
              <div className="flex gap-2 mt-3">
                <div className="h-6 bg-stone-50 rounded-full w-24" />
                <div className="h-6 bg-stone-50 rounded-full w-16" />
              </div>
            </div>
          </div>
        </div>
