  ...
  if (!userId) {
    return (
      <div className="text-center py-12 bg-mn-elevated rounded-2xl border border-white/5">
        ...
        <p className="text-mn-mute font-medium">Bitte melde dich an, um einen Vorschlag einzureichen.</p>
      </div>
    )
  }

  return (
    <form onSubmit={handleSubmit} className="bg-mn-elevated rounded-2xl border border-white/5 shadow-sm p-5 space-y-4">
      <div>
        <h2 className="text-lg font-bold text-mn-ink mb-1">Organisation vorschlagen</h2>
      ...
      {/* Name */}
      <div>
        <label htmlFor="org-name" className="block text-sm font-medium text-mn-ink-soft mb-1">
        ...
        <input
          ...
          className="w-full text-sm p-3 border border-white/5 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-300"
        />
      </div>

      {/* Description */}
      <div>
        <label htmlFor="org-desc" className="block text-sm font-medium text-mn-ink-soft mb-1">
          Beschreibung
        </label>
        <textarea
          id="org-desc"
          ...
          className="w-full text-sm p-3 border border-white/5 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-primary-300"
          rows={3}
        />
      </div>
      ...
      {/* Category */}
      <div>
        <label htmlFor="org-cat" className="block text-sm font-medium text-mn-ink-soft mb-1">
          Kategorie *
        </label>
        <select
          id="org-cat"
          ...
          className="w-full text-sm p-3 border border-white/5 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-300 bg-mn-elevated"
        >
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          <label htmlFor="org-country" className="block text-sm font-medium text-mn-ink-soft mb-1">
            Land
          </label>
          <select
            id="org-country"
        ...
        <div>
          <label htmlFor="org-city" className="block text-sm font-medium text-mn-ink-soft mb-1">
            Stadt
          </label>
          <input
            id="org-city"
      ...
      {/* Address */}
      <div>
        <label htmlFor="org-addr" className="block text-sm font-medium text-mn-ink-soft mb-1">
          Adresse
        </label>
        <input
          id="org-addr"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div>
          <label htmlFor="org-phone" className="block text-sm font-medium text-mn-ink-soft mb-1">
            Telefon
          </label>
          <input
            id="org-phone"
        ...
        <div>
          <label htmlFor="org-email" className="block text-sm font-medium text-mn-ink-soft mb-1">
            E-Mail
          </label>
          <input
            id="org-email"
      ...
      {/* Website */}
      <div>
        <label htmlFor="org-web" className="block text-sm font-medium text-mn-ink-soft mb-1">
          Website
        </label>
        <input
          id="org-web"
