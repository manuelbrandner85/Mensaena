  ...
  return (
    <div className="space-y-4">
      ...
      {loading ? (
        ...
        <>
          <p className="text-sm text-gray-500">{total} Gruppen gesamt</p>
              ...
              <table className="w-full text-sm">
                <thead className="bg-gray-50 border-b border-gray-100">
                  <tr>
                    ...
                    <th className="text-center px-4 py-3 font-semibold text-gray-700">Mitglieder</th>
                        ...
                        <tr className="bg-gray-50">
                          <td colSpan={6} className="px-6 py-3">
                            ...
                            {!members[g.id] ? (
                              ...
                              <p className="text-xs text-gray-400">Keine Mitglieder</p>
                            ) : (
                              <div className="flex flex-wrap gap-2">
                                {members[g.id].map(m => {
                                  ...
                                  return (
                                    <div key={m.id} className="flex items-center gap-1.5 bg-white border border-gray-200 rounded-lg px-2.5 py-1 text-xs">
                                      <span className="font-medium text-gray-700">{mName ?? m.user_id.slice(0, 8)}</span>
                                      {m.role !== 'member' && (
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => setEditGroup(null)} className="p-1.5 rounded-lg hover:bg-gray-100 text-gray-500">
                <X className="w-4 h-4" />
              </button>
            </div>
