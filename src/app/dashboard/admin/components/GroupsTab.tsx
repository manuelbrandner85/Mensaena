  ...
  return (
    <div className="space-y-4">
      ...
      {loading ? (
        ...
        <>
          <p className="text-sm text-mn-mute">{total} Gruppen gesamt</p>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead className="bg-mn-surface border-b border-white/5">
                  <tr>
                    <th className="text-left px-4 py-3 font-semibold text-mn-ink-soft">Gruppe</th>
                    <th className="text-left px-4 py-3 font-semibold text-mn-ink-soft">Kategorie</th>
                    <th className="text-center px-4 py-3 font-semibold text-mn-ink-soft">Mitglieder</th>
                ...
                <tbody className="divide-y divide-stone-100">
                      ...
                      {expanded === g.id && (
                        <tr className="bg-mn-surface">
                          <td colSpan={6} className="px-6 py-3">
                            <p className="text-xs font-semibold text-mn-mute mb-2">Mitglieder ({members[g.id]?.length ?? '…'})</p>
                            {!members[g.id] ? (
                              ...
                              <p className="text-xs text-mn-mute">Keine Mitglieder</p>
                            ) : (
                  ...
                  {groups.length === 0 && (
                    <tr><td colSpan={6} className="px-4 py-12 text-center text-mn-mute">Keine Gruppen gefunden</td></tr>
                  )}
                </tbody>
              </table>
            </div>
