    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-black text-mn-ink">Krise melden</h1>
            <p className="text-sm text-mn-mute">Melde einen Notfall und mobilisiere Helfer in deiner Nähe</p>
          </div>
        </div>
      </div>
