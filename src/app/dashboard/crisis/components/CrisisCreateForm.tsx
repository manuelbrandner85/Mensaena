  ...
  return (
    <div className="bg-white border border-stone-100 rounded-2xl shadow-sm overflow-hidden">
      ...
      <div className="p-4 sm:p-6">
        ...
        {step === 1 && (
          <div>
            <h3 className="text-base font-bold text-ink-900 mb-1">Was ist passiert?</h3>
            <p className="text-xs text-ink-500 mb-4">Wähle die Kategorie und Dringlichkeit der Krise.</p>

            <div className="mb-6">
              <label className="text-xs font-semibold text-ink-700 mb-2 block">Kategorie *</label>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        category === key
                          ...
                          : 'bg-white border-stone-200 text-ink-700 hover:bg-stone-50',
                      )}
            ...
            <div className="mb-6">
              <label className="text-xs font-semibold text-ink-700 mb-2 block">Dringlichkeit *</label>
        ...
        {step === 2 && (
          <div>
            <h3 className="text-base font-bold text-ink-900 mb-1">Beschreibe die Krise</h3>
            <p className="text-xs text-ink-500 mb-4">Gib so viele Details wie möglich an.</p>

            <div className="space-y-4">
              <div>
                <label className="text-xs font-semibold text-ink-700 mb-1 block">Titel * (5-200 Zeichen)</label>
                <input
                  type="text"
                  value={title}
                  ...
                  maxLength={200}
                />
                <span className="text-xs text-ink-400 mt-1 block">{title.length}/200</span>
              </div>

              <div>
                <label className="text-xs font-semibold text-ink-700 mb-1 block">Beschreibung * (10-5000 Zeichen)</label>
                <textarea
                  value={description}
                  onChange={e => setDescription(e.target.value)}
                  placeholder="Was genau ist passiert? Wie viele Menschen sind betroffen? Welche Hilfe wird gebraucht?"
                  className="w-full px-3 py-2.5 border border-stone-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-red-200 min-h-[120px] resize-y"
                  maxLength={5000}
                />
                <span className="text-xs text-ink-400 mt-1 block">{description.length}/5000</span>
              </div>

              <div>
                <label className="text-xs font-semibold text-ink-700 mb-1 block">Standort</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2.5 border border-stone-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-red-200"
                  />
                </div>
              </div>
              ...
              {/* Image upload */}
              <div>
                <label className="text-xs font-semibold text-ink-700 mb-2 block">Fotos (optional)</label>
                <div className="flex flex-wrap gap-2">
                  ...
                  {onUploadImage && imageUrls.length < 4 && (
                    <button
                      ...
                      disabled={uploading}
                      className="w-20 h-20 border-2 border-dashed border-stone-300 rounded-xl flex flex-col items-center justify-center text-ink-400 hover:border-red-300 hover:text-red-400 transition-colors"
                    >
        ...
        {step === 3 && (
          <div>
            <h3 className="text-base font-bold text-ink-900 mb-1">Details & Kontakt</h3>
            <p className="text-xs text-ink-500 mb-4">Hilf uns, die richtige Unterstützung zu koordinieren.</p>

            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-xs font-semibold text-ink-700 mb-1 block flex items-center gap-1">
              ...
              {/* Skills */}
              <div>
                <label className="text-xs font-semibold text-ink-700 mb-2 block flex items-center gap-1">
              ...
              <div className="pt-2 border-t border-stone-100">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
                  <input
                    ...
                    className="px-3 py-2 border border-stone-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-red-200"
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4 rounded border-stone-300 text-red-600 focus:ring-red-200"
                  />
                  <span className="text-xs text-ink-600">Anonym melden</span>
                </label>
              </div>
        ...
        <div className="flex items-center justify-between mt-6 pt-4 border-t border-stone-100">
          {step > 1 ? (
            <button
              ...
              className="flex items-center gap-1 px-4 py-2 bg-stone-100 text-ink-700 rounded-xl text-sm font-medium hover:bg-stone-200 transition-colors"
            >
