  ...
  return (
    <div className="px-4 sm:px-6 py-6 max-w-7xl mx-auto" aria-busy="true" aria-label="Wird geladen">
      ...
      <div className="mb-6 animate-pulse">
        <div className="h-7 w-48 bg-mn-raised rounded-lg mb-2" />
        <div className="h-4 w-72 bg-mn-elevated rounded" />
      </div>
          ...
          >
            <div className="flex items-start gap-3 mb-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="h-4 w-3/4 bg-mn-raised rounded mb-2" />
                <div className="h-3 w-1/2 bg-mn-elevated rounded" />
              </div>
            </div>
            <div className="space-y-2">
              <div className="h-3 w-full bg-mn-elevated rounded" />
              <div className="h-3 w-5/6 bg-mn-elevated rounded" />
              <div className="h-3 w-4/6 bg-mn-elevated rounded" />
            </div>
          </div>
        ))}
      </div>
