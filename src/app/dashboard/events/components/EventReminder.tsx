  ...
  if (!reminderSet) {
    return (
      <button
        ...
        disabled={saving}
        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium border border-white/5 text-mn-ink-soft hover:bg-mn-surface transition disabled:opacity-50"
      >
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <select
        ...
        disabled={saving}
        className="text-sm border border-white/5 rounded-lg px-2 py-1 bg-mn-elevated focus:outline-none focus:ring-2 focus:ring-purple-500 disabled:opacity-50"
      >
      ...
      <button
        ...
        disabled={saving}
        className="p-1 rounded-full hover:bg-mn-elevated transition disabled:opacity-50"
