    ...
    <div className="space-y-3">
      ...
      <label className="flex items-center gap-3 cursor-pointer">
        ...
        <div className="flex items-center gap-1.5">
          <Repeat className="w-4 h-4 text-ink-600" />
          <span className="text-sm font-medium text-ink-700">Wiederkehrende Veranstaltung</span>
        </div>
      </label>
      ...
      {enabled && (
        <div className="pl-[52px] space-y-3">
          <div>
            <label className="text-sm text-ink-600 mb-1 block">Wiederholung</label>
            <select
              value={frequency}
          ...
          <div>
            <label className="text-sm text-ink-600 mb-1 block">Wiederholen bis</label>
            <input
              type="date"
              value={until}
