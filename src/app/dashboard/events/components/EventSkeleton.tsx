...
function Bone({ className }: { className?: string }) {
  return <div className={cn('bg-mn-raised rounded-lg animate-pulse', className)} />
}

function CardSkeleton() {
  return (
    <div className="bg-mn-elevated rounded-xl border border-white/5 p-4 flex flex-col sm:flex-row gap-4">
...
export function CalendarSkeleton() {
  return (
    <div>
      ...
      <div className="grid grid-cols-7 gap-px bg-mn-elevated rounded-xl overflow-hidden">
        {Array.from({ length: 35 }).map((_, i) => (
          <div key={i} className="bg-mn-elevated min-h-[80px] md:min-h-[100px] p-1">
