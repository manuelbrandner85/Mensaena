...
const TYPE_CONFIG: Record<string, TypeConfig> = {
  ...
  mobility:  { label: 'Mobilitaet',        emoji: '🚗', color: 'text-indigo-700',  bg: 'bg-indigo-50 border-indigo-200',  dot: 'bg-indigo-500'  },
  ...
  help_offer:   { label: 'Hilfe angeboten',  emoji: '💚', color: 'text-green-700',  bg: 'bg-green-50 border-green-200',   dot: 'bg-green-500'   },
