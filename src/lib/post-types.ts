...
const TYPE_CONFIG: Record<string, TypeConfig> = {
  ...
  housing:   { label: 'Wohnangebot',       emoji: '🏡', color: 'text-mn-teal-soft',    bg: 'bg-blue-50 border-blue-200',      dot: 'bg-blue-500'    },
  ...
  crisis:    { label: 'Notfall',           emoji: '🚨', color: 'text-mn-herzrot',     bg: 'bg-red-100 border-red-400',       dot: 'bg-red-600'     },
  // Legacy fallbacks
