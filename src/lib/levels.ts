...
export const LEVELS: UserLevel[] = [
  ...
  { level: 2, name: 'Nachbar',    emoji: '🏘️', minPoints: 100,  maxPoints: 299,  color: 'text-primary-700', bgColor: 'bg-primary-50',  borderColor: 'border-mn-bronze/20' },
  ...
  { level: 4, name: 'Held',       emoji: '🦸', minPoints: 600,  maxPoints: 999,  color: 'text-mn-bronze', bgColor: 'bg-mn-surface',   borderColor: 'border-white/5' },
